...
export const Login = () => {
  ...
  const logInUserDetails = useSelector((state) => state.authReducer.loggedInUser);
  ...
  useEffect(() => {
    if (logInUserDetails?.message) {
      ...
      setError(logInUserDetails?.error);
    }
  }, [loggedInUser]);
    ...
    <>
      <div className="lg:flex">
        ...
        {message && (
          <div
            id="alert-3"
            className="flex p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200 absolute w-full left-0 top-20 lg:w-2/4 xl:max-w-screen-sm"
            role="alert"
          >
            <svg
              aria-hidden="true"
        ...
        {error && (
          <div
            id="alert-2"
            className="flex p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200 absolute w-full left-0 top-20 lg:w-2/4 xl:max-w-screen-sm"
            role="alert"
          >
            <svg
              aria-hidden="true"
